...
def download_logic(call):
    ...
    # Bloklarni chetlab o'tish parametrlari
    ...
    try:
        ...
        bot.send_message(chat_id, "❌ Xatolik yuz berdi. YouTube bu ulanishni cheklagan bo'lishi mumkin.")
    
    bot.delete_message(chat_id, status_msg.message_id)

# Ulanish uzilganda botni qayta ishga tushirish (Connection Reset himoyasi)
if __name__ == "__main__":
    while True:
        try:
            ...
            print(f"Ulanishda xato: {e}. 5 soniyadan so'ng qayta uriniladi...")
            time.sleep(5)
